        ...
        steps: [
          {
            ...
            popover: {
              title: "sercing",
              description: "Ini teh buat sercing sercing yagesya.",
              side: "top",
              align: "start",
            },
          },
    ...
    <nav className="bg-gray-900 text-white py-4">
      ...
      <div className="container mx-auto flex items-center justify-between px-4 lg:px-8">
        ...
        <div className="lg:hidden">
          <button onClick={() => setOffcanvas(!offcanvas)} className="p-2 bg-gray-700 rounded">
            <svg
        ...
        <div className="flex items-center space-x-6" id="search">
          ...
          <form onSubmit={handleSearch} className="flex items-center w-full lg:block hidden">
            <input
              id="seacrh"
              type="text"
              placeholder="Search..."
            ...
            />
            <button type="submit" className="bg-gray-700 py-2 px-3 rounded-r hover:bg-gray-600">
              🔎
            </button>
          </form>
        </div>
      ...
      <div className="bg-gray-800 py-2 mt-4 hidden lg:block">
        <div className="container mx-auto text-center">
          <ul id="category" className="flex flex-wrap justify-center space-x-6">
            {items.map((item) => (
              <li key={item.name}>
      ...
      >
        <button className="absolute top-4 right-4 bg-gray-700 p-2 rounded" onClick={() => setOffcanvas(false)}>
          <svg
            xmlns="http://www.w3.org/2000/svg"
            className="h-6 w-6"
            fill="none"
        ...
        {isLoggedIn ? (
          <div className="space-y-4 mt-6">
            ...
            <button onClick={handleLogout} className="bg-red-500 text-sm px-4 py-2 rounded hover:bg-red-600 w-full">
              Logout
            </button>
          </div>
        ) : (
          <div className="space-y-4 mt-6">
            <Link href="/register" legacyBehavior>
              <a className="bg-blue-500 text-sm px-4 py-2 rounded hover:bg-blue-600 block text-center">Register</a>
            </Link>
            <Link href="/login" legacyBehavior>
              <a className="bg-green-500 text-sm px-4 py-2 rounded hover:bg-green-600 block text-center">Login</a>
            </Link>
          </div>
        )}
      </div>
